// After the build process is refactored, the following module-load statments
// will be required by all components
//
// var FamousEngine = require('famous-engine');
// var FamousFramework = require('famous-framework')(FamousEngine);
